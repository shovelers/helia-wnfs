...
*/
  constructor(accumulator: NameAccumulator);
/**
* @param {PrivateForest} forest
* @returns {NameAccumulator}
*/
  toNameAccumulator(forest: PrivateForest): NameAccumulator;
}
/**
*/
...
* @returns {NameAccumulator}
*/
  static fromBytes(bytes: Uint8Array): NameAccumulator;
/**
* @returns {Uint8Array}
*/
  toBytes(): Uint8Array;
...
export interface InitOutput {
  ...
  readonly name_new: (a: number) => number;
  readonly name_toNameAccumulator: (a: number, b: number) => number;
  readonly nameaccumulator_fromBytes: (a: number, b: number, c: number) => void;
  readonly nameaccumulator_toBytes: (a: number, b: number) => void;
  ...
  readonly publicfile_new: (a: number) => number;
