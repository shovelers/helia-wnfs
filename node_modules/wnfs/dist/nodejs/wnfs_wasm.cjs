...
* @returns {Promise<any>}
*/
module.exports.share = function(access_key, share_count, sharer_root_did, recipient_exchange_root, forest, store) {
    try {
...
* @returns {Name}
*/
module.exports.createShareName = function(share_count, sharer_root_did, recipient_exchange_key, forest) {
...
* @returns {Promise<any>}
*/
module.exports.findLatestShareCounter = function(share_count, limit, recipient_exchange_key, sharer_root_did, forest, store) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Promise<any>}
*/
module.exports.receiveShare = function(share_name, recipient_key, forest, store) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
module.exports.ForeignPrivateKey = ForeignPrivateKey;
...
module.exports.ForestChange = ForestChange;
...
class Name {
    ...
    /**
    * @param {NameAccumulator} accumulator
    */
    constructor(accumulator) {
        _assertClass(accumulator, NameAccumulator);
        const ret = wasm.name_new(accumulator.__wbg_ptr);
    ...
    * @returns {NameAccumulator}
    */
    toNameAccumulator(forest) {
        _assertClass(forest, PrivateForest);
        const ret = wasm.name_toNameAccumulator(this.__wbg_ptr, forest.__wbg_ptr);
        return NameAccumulator.__wrap(ret);
    }
}
...
class NameAccumulator {
    ...
    */
    static fromBytes(bytes) {
        try {
            ...
            const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export_0);
            const len0 = WASM_VECTOR_LEN;
            wasm.nameaccumulator_fromBytes(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
            ...
            return NameAccumulator.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    ...
    */
    toBytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.nameaccumulator_toBytes(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_export_4(r0, r1 * 1, 1);
...
module.exports.NameAccumulator = NameAccumulator;
...
module.exports.PrivateDirectory = PrivateDirectory;
...
module.exports.PrivateFile = PrivateFile;
...
module.exports.PrivateForest = PrivateForest;
...
module.exports.PrivateNode = PrivateNode;
...
class PublicDirectory {
    ...
    */
    asNode() {
        const ret = wasm.publicdirectory_asNode(this.__wbg_ptr);
...
module.exports.PublicDirectory = PublicDirectory;
...
class PublicFile {
    ...
    */
    constructor(time) {
        try {
            const ret = wasm.publicfile_new(addBorrowedObject(time));
            this.__wbg_ptr = ret >>> 0;
            return this;
        } finally {
            heap[stack_pointer++] = undefined;
    ...
    * @returns {Promise<any>}
    */
    readAt(byte_offset, limit, store) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.publicfile_readAt(retptr, this.__wbg_ptr, addHeapObject(byte_offset), isLikeNone(limit) ? 0 : addHeapObject(limit), addHeapObject(store));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    * @returns {Promise<any>}
    */
    setContent(time, content, store) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(content, wasm.__wbindgen_export_0);
            const len0 = WASM_VECTOR_LEN;
            wasm.publicfile_setContent(retptr, this.__wbg_ptr, addBorrowedObject(time), ptr0, len0, addHeapObject(store));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    asNode() {
        const ret = wasm.publicfile_asNode(this.__wbg_ptr);
        return PublicNode.__wrap(ret);
    }
}
module.exports.PublicFile = PublicFile;
...
class PublicNode {
    ...
    */
    asFile() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.publicnode_asFile(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
module.exports.PublicNode = PublicNode;
...
module.exports.__wbg_putBlock_63a57c1e3c803621 = function(arg0, arg1, arg2, arg3) {
    var v0 = getArrayU8FromWasm0(arg1, arg2).slice();
    wasm.__wbindgen_export_4(arg1, arg2 * 1, 1);
    const ret = getObject(arg0).putBlock(v0, arg3 >>> 0);
    return addHeapObject(ret);
};

module.exports.__wbg_getBlock_51488d6134c2b0f6 = function(arg0, arg1, arg2) {
    var v0 = getArrayU8FromWasm0(arg1, arg2).slice();
    wasm.__wbindgen_export_4(arg1, arg2 * 1, 1);
...
module.exports.__wbg_accesskey_new = function(arg0) {
    const ret = AccessKey.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_privatedirectory_new = function(arg0) {
    const ret = PrivateDirectory.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_fromModulus_8db5ea5c0725f65b = function(arg0, arg1) {
    const ret = ExchangeKey.fromModulus(getArrayU8FromWasm0(arg0, arg1));
    return addHeapObject(ret);
};

module.exports.__wbg_encrypt_225a0bcca0d36d88 = function(arg0, arg1, arg2) {
    const ret = getObject(arg0).encrypt(getArrayU8FromWasm0(arg1, arg2));
    return addHeapObject(ret);
};

module.exports.__wbg_decrypt_fedba3a3337f0609 = function(arg0, arg1, arg2) {
    const ret = getObject(arg0).decrypt(getArrayU8FromWasm0(arg1, arg2));
    return addHeapObject(ret);
};

module.exports.__wbg_privatefile_new = function(arg0) {
    const ret = PrivateFile.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_privateforest_new = function(arg0) {
    const ret = PrivateForest.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_privatenode_new = function(arg0) {
    const ret = PrivateNode.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_forestchange_new = function(arg0) {
    const ret = ForestChange.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_randomBytes_ecd1826923d31ea9 = function(arg0, arg1, arg2) {
...
module.exports.__wbg_publicdirectory_new = function(arg0) {
    const ret = PublicDirectory.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_publicfile_new = function(arg0) {
    const ret = PublicFile.__wrap(arg0);
    return addHeapObject(ret);
};

module.exports.__wbg_publicnode_new = function(arg0) {
...
module.exports.__wbg_valueOf_451be10c549f0f57 = function(arg0) {
...
module.exports.__wbindgen_closure_wrapper3832 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 673, __wbg_adapter_30);
    return addHeapObject(ret);
};

const path = require('path').join(__dirname, 'wnfs_wasm_bg.wasm');
